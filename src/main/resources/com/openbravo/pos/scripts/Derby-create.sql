...
CREATE TABLE STOCKEXPIRED (
    ...
    PRIMARY KEY (PRODUCT),
    CONSTRAINT STOCKEXPIRED_PRODUCT FOREIGN KEY (PRODUCT) REFERENCES PRODUCTS(ID),
    CONSTRAINT STOCKEXPIRED_LOCATION FOREIGN KEY (LOCATION) REFERENCES LOCATIONS(ID)

...
CREATE TABLE CATEGORIES (
    ...
    DISCOUNT_THRESHOLD DOUBLE DEFAULT 0,
...
CREATE TABLE PRODUCTS (
    ...
    BUNDLE_UNITS DOUBLE  DEFAULT 0 NOT NULL,
    BUNDLE_SELL_PRICE DOUBLE  DEFAULT 0 NOT NULL,
    BOX_UNITS DOUBLE  DEFAULT 0 NOT NULL,
    BOX_SELL_PRICE DOUBLE  DEFAULT 0 NOT NULL,
    PRIMARY KEY (ID),

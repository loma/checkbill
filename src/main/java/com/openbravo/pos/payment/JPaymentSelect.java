...
// * Bank Payment receipt - Thanks Steve Clough! August 2011
	...
	private void printState() {
		...
		((JPaymentInterface) m_jTabPayment.getSelectedComponent()).activate(
				customerext, m_dTotal - m_aPaymentInfo.getTotal(), m_sTransactionID);
	}
    ...
    private void initComponents() {
        ...
        m_jLblTotalEuros1.setPreferredSize(new java.awt.Dimension(160, 30));
        ...
        m_jLblRemainingEuros.setPreferredSize(new java.awt.Dimension(130, 30));
        ...
        m_jButtonAdd.setPreferredSize(new java.awt.Dimension(50, 50));
        ...
        m_jButtonRemove.setPreferredSize(new java.awt.Dimension(50, 50));
        ...
        jPanel3.setName("payment_confirm_panel"); // NOI18N
        ...
        m_jTabPayment.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
        ...
        m_jButtonOK.setName("payment_okay1234"); // NOI18N
        ...
        m_jButtonPrint.setPreferredSize(new java.awt.Dimension(50, 50));
        ...
        jPanel7.add(m_jButtonPrint);

        jPanel5.add(jPanel7, java.awt.BorderLayout.WEST);

        getContentPane().add(jPanel5, java.awt.BorderLayout.SOUTH);

        setSize(new java.awt.Dimension(947, 631));

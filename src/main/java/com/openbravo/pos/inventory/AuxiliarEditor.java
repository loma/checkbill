...
public class AuxiliarEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    @SuppressWarnings("unchecked")
        ...
        private void initComponents() {
                ...
                add(jLabel3);
                jLabel3.setBounds(10, 11, 100, 25);
                ...
                add(m_jEnter2);
                m_jEnter2.setBounds(710, 0, 50, 50);

                m_jSearch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/search24.png"))); // NOI18N
                m_jSearch.setPreferredSize(new java.awt.Dimension(50, 50));
                m_jSearch.setSize(new java.awt.Dimension(50, 50));
                ...
                add(m_jSearch);
                m_jSearch.setBounds(320, 50, 50, 50);

                m_jProduct.setEditable(false);
                m_jProduct.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
                ...
                add(m_jProduct);
                m_jProduct.setBounds(90, 60, 220, 25);

                m_jBarcode.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
                ...
                add(m_jBarcode);
                m_jBarcode.setBounds(480, 10, 220, 25);
                ...
                add(jLabel4);
                jLabel4.setBounds(410, 10, 70, 25);

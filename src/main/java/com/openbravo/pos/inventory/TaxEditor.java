...
public class TaxEditor extends JPanel implements EditorRecord {
     ...
     */
        ...
        private void initComponents() {
                ...
                m_jRate.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
                add(m_jRate);
                ...
                jCascade.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
                jCascade.setText(AppLocal.getIntString("label.cascade")); // NOI18N
                add(jCascade);
                jCascade.setBounds(320, 140, 110, 25);

                m_jTaxCategory.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
                add(m_jTaxCategory);
                m_jTaxCategory.setBounds(240, 50, 200, 25);

                m_jTaxParent.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
                add(m_jTaxParent);
                m_jTaxParent.setBounds(240, 110, 200, 25);

                m_jCustTaxCategory.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
                ...
                jOrder.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
                add(jOrder);

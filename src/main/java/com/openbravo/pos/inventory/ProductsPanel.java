...
public class ProductsPanel extends JPanelTable2 implements EditorListener {
    ...
    public void activate() throws BasicException {
        ...
        if (StartPOS.TempProductCode != null) {
            Object[] tempProduct = (Object[]) jeditor.createValue();
            tempProduct[1] = StartPOS.TempProductCode;
            tempProduct[2] = StartPOS.TempProductCode;
            StartPOS.TempProductCode = null;
            jeditor.writeValueEdit(tempProduct);
            jeditor.setDefaultTaxAndCategory();
        }
    }

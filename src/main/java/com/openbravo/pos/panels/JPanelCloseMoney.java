...
public class JPanelCloseMoney extends JPanel implements JPanelView, BeanFactoryApp {
    ...
    private void loadData() throws BasicException {
        ...
        jColumns.getColumn(0).setPreferredWidth(180);
        ...
        jColumns.getColumn(1).setPreferredWidth(130);
        jColumns.getColumn(1).setResizable(false);
        jColumns.getColumn(2).setPreferredWidth(130);
    ...
    private static String Printer_CloseCash = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
        + "<output>\n"
        + "	<ticket>\n"
        ...
        + "		<line></line>\n"
        + "		<line>\n"
        + "			<text align =\"left\" bold=\"true\" length=\"27\">Payments Report</text>\n"
        + "			<text align =\"right\" bold=\"true\" length=\"15\">Amount</text>\n"
        + "		</line>\n"
        + "		<line>\n"
        + "			<text>------------------------------------------</text>\n"
        + "		</line>\n"
        ...
        + "		<line>\n"
        + "			<text align =\"left\" length=\"27\">${line.printType()} ${line.printReason()}</text>\n"
        ...
        + "		</line>\n"
        + "		<line>\n"
        + "			<text align =\"left\" length=\"27\" bold=\"true\">Total Sales</text>\n"
        ...
        + "		<line></line>\n"
        + "		<line>\n"
        + "			<text align =\"left\" bold=\"true\" length=\"27\">Tax Analysis</text>\n"
        + "			<text align =\"right\" bold=\"true\" length=\"15\">Amount</text>\n"
        + "		</line>\n"
        + "		<line>\n"
        + "			<text>------------------------------------------</text>\n"
        ...
        + "		<line>\n"
        + "			<text align =\"left\" length=\"27\">${line.printTaxName()}</text>\n"
        + "			<text align =\"right\" length=\"15\">${line.printTaxes()}</text>\n"
        + "		</line>\n"
        + "		#end\n"
        + "		<line>\n"
        + "			<text>------------------------------------------</text>\n"
    ...
    private void printPayments(String report) {
        ...
        if (report.equals("Printer.CloseCash")) {
            sresource = Printer_CloseCash;
        }
        if (sresource == null) {
     ...
     */
        ...
        private void initComponents() {
                ...
                jPanel4.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
                ...
                m_jSequence.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
                ...
                m_jMinDate.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
                ...
                m_jMaxDate.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
                ...
                jPanel5.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N

                m_jScrollTableTicket.setBorder(null);
                m_jScrollTableTicket.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
                ...
                m_jTicketTable.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
                ...
                m_jCount.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
                ...
                m_jCash.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
                ...
                m_jSales.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
                ...
                m_jSalesSubtotal.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
                m_jSalesSubtotal.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

                m_jScrollSales.setBorder(null);
                m_jScrollSales.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N

                m_jsalestable.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
                ...
                m_jSalesTaxes.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
                ...
                m_jSalesTotal.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
                ...
                jPanel5Layout.setHorizontalGroup(
                        ...
                        .addGroup(jPanel5Layout.createSequentialGroup()
                                .addGap(2, 2, 2)
                                .addComponent(m_jScrollTableTicket, javax.swing.GroupLayout.PREFERRED_SIZE, 315, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(m_jScrollSales, javax.swing.GroupLayout.PREFERRED_SIZE, 415, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                                                ...
                                                .addComponent(m_jNoCashSales, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addContainerGap())
                );
                ...
                m_jCloseCashTop.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
                ...
                m_jPrintCashTop.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
                ...
                jPanelTopLayout.setVerticalGroup(
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelTopLayout.createSequentialGroup()
                                .addGroup(jPanelTopLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(m_jPrintCashTop, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(m_jCloseCashTop, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addContainerGap())
                );

                m_jCloseCash.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
                ...
                m_jPrintCash.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
                ...
                jPanelBottomLayout.setHorizontalGroup(
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelBottomLayout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(m_jPrintCash, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(m_jCloseCash, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE)
                                .addContainerGap(55, Short.MAX_VALUE))
                );
                jPanelBottomLayout.setVerticalGroup(
                        jPanelBottomLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanelBottomLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(m_jCloseCash, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(m_jPrintCash, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                );

...
public class JMessageDialog extends javax.swing.JDialog {
        ...
        if (inf.getCause() == null) {
            ...
            if (inf.getCause() instanceof Throwable) {
                ...
                for (int i = 0; i < m_aExceptions.length; i++) {
                    ...
                    sb.append("Stack Trace: \n");
                    for (StackTraceElement s : m_aExceptions[i].getStackTrace()){
                        sb.append(s.toString());
                        sb.append("\n");
                    }
                    sb.append("\n");
    ...
    private void initComponents() {
        ...
        jlblMessage.setMinimumSize(new java.awt.Dimension(200, 15));
        jlblMessage.setPreferredSize(new java.awt.Dimension(200, 15));
        ...
        jcmdOK.setPreferredSize(new java.awt.Dimension(80, 50));
        ...
        jcmdMore.setFont(new java.awt.Font("Saysettha OT", 0, 16)); // NOI18N
        ...
        jcmdMore.setPreferredSize(new java.awt.Dimension(80, 50));
        ...
        setSize(new java.awt.Dimension(634, 230));
